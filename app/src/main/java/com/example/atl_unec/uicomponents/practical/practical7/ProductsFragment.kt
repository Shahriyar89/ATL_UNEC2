    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val productList = arrayListOf(
            ...
            Product(
                title = "Lenovo",
                price = "3000$",
                logoUrl = "https://icon2.cleanpng.com/lnd/20240422/hvr/transparent-little-black-girl-fashion-style-clothing-outfit-image-url-required-for-picture-submission6626f0e8a25679.39246553.webp",
                isActive = true,
                description = ""
            ),
            Product(
